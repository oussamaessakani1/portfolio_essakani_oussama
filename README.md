...
- **Dynamic Typing Animation**: An interactive hero section featuring a professional typewriter effect.
- **Intersection Observer Reveal**: Smooth "scroll-to-reveal" animations for every section.
- **Dual Theme Support**: Seamless switching between Dark Mode and Light Mode.
...
- **Glassmorphic Components**: Cards, buttons, and sections utilize modern backdrop-blur effects.
...
- **Zero Overflow**: Meticulous layout management ensures no horizontal scrolling on even the smallest devices.
...
- **JavaScript (Vanilla)**: Lightweight, performance-optimized logic for animations, theme switching, and mobile interaction.
...
```text
├── images/           # High-quality SVG and JPG assets
